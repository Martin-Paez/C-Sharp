...
using TP.TP7.Clases.Fabricas.Compa_rable_rador;
...
using TP.TP7.Clases.Fabricas.Compa_rable_rador.Comparables;
...
namespace TP.TP7.Clases.Fabricas.Comparables
{
    public abstract class FabricaDeComparables<T> where T : Comparable<T>
    {
        ...
        protected GenDatos Gen = LectorDeArchivos.GetInstance(
                                    GenAleatorioDeDatos.GetInstance(
                                    LectorDeDatos.GetInstance(null)));
        ...
        public static T Input(Comparador<T>? cmp = null, StrategyComparable<T>? e = null, bool soloComparador = false)
        {
            return Crear(cmp, e, soloComparador).Input();
        }
